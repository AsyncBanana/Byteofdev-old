...
<svelte:head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Inter:wght@700&family=Quattrocento&family=Inter:wght@400&display=swap"
		rel="stylesheet"
	/>
</svelte:head>
<div class={`shadow bg-base-200 drawer ${theme.value}`}>
	...
	<div class="flex flex-col min-h-screen drawer-content" style="scroll-behavior: smooth;">
		<div class="rounded-box mx-auto bg-base-100 mt-3 mb-6 top-0 z-30 navbar sticky sm:w-3/4">
			<div class="flex-1 mx-2 px-2">
				<a class="font-extrabold text-xl" href="/">SyntaxHighlight</a>
			</div>
			<button
				on:click={() => {
